--- 
title: conditional_access_named_locations
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>conditional_access_named_locations</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="conditional_access_named_locations" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity.conditional_access_named_locations" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Retrieve the properties and relationships of a countryNamedLocation object.</td>
</tr>
<tr>
    ...
    <td>Get a list of namedLocation objects.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Create a new namedLocation object. Named locations can be either ipNamedLocation or countryNamedLocation objects.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Update the properties of a countryNamedLocation object.</td>
</tr>
<tr>
    ...
    <td>Delete a countryNamedLocation object.</td>
</tr>
<tr>
...
displayName,
modifiedDateTime
FROM entraid.identity.conditional_access_named_locations
...
```sql
INSERT INTO entraid.identity.conditional_access_named_locations (
deletedDateTime,
@odata.type,
createdDateTime,
displayName,
...
- name: conditional_access_named_locations
  props:
...
```sql
UPDATE entraid.identity.conditional_access_named_locations
SET 
...
```sql
DELETE FROM entraid.identity.conditional_access_named_locations
WHERE namedLocation-id = '{{ namedLocation-id }}' --required
...
```sql
EXEC entraid.identity.conditional_access_named_locations.restore 
@namedLocation-id='{{ namedLocation-id }}' --required
;
```
</TabItem>
