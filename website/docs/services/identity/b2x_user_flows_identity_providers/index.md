...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity.b2x_user_flows_identity_providers" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-b2xIdentityUserFlow-id"><code>b2xIdentityUserFlow-id</code></a>, <a href="#parameter-identityProvider-id"><code>identityProvider-id</code></a></td>
...
clientSecret,
type
FROM entraid.identity.b2x_user_flows_identity_providers
WHERE b2xIdentityUserFlow-id = '{{ b2xIdentityUserFlow-id }}' -- required
AND identityProvider-id = '{{ identityProvider-id }}' -- required
AND $select = '{{ $select }}'
AND $expand = '{{ $expand }}'
;
```
