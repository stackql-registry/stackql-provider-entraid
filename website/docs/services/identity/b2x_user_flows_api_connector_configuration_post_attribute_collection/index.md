--- 
title: b2x_user_flows_api_connector_configuration_post_attribute_collection
hide_title: false
hide_table_of_contents: false
keywords:
  - b2x_user_flows_api_connector_configuration_post_attribute_collection
  - identity
  - entra_id
...
Creates, updates, deletes, gets or lists a <code>b2x_user_flows_api_connector_configuration_post_attribute_collection</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="b2x_user_flows_api_connector_configuration_post_attribute_collection" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.identity.b2x_user_flows_api_connector_configuration_post_attribute_collection" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO entra_id.identity.b2x_user_flows_api_connector_configuration_post_attribute_collection (
@odata.id,
@odata.type,
...
- name: b2x_user_flows_api_connector_configuration_post_attribute_collection
  props:
    - name: b2xIdentityUserFlow-id
      value: "{{ b2xIdentityUserFlow-id }}"
      description: Required parameter for the b2x_user_flows_api_connector_configuration_post_attribute_collection resource.
    - name: @odata.id
      value: "{{ @odata.id }}"
    - name: @odata.type
      value: "{{ @odata.type }}"
...
```sql
UPDATE entra_id.identity.b2x_user_flows_api_connector_configuration_post_attribute_collection
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entra_id.identity.b2x_user_flows_api_connector_configuration_post_attribute_collection
...
```sql
EXEC entra_id.identity.b2x_user_flows_api_connector_configuration_post_attribute_collection.upload_client_certificate 
@b2xIdentityUserFlow-id='{{ b2xIdentityUserFlow-id }}' --required 
@@json=
'{
