...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity.conditional_access_deleted_items_named_locations" /></td></tr>
</tbody></table>
...
displayName,
modifiedDateTime
FROM entraid.identity.conditional_access_deleted_items_named_locations
...
```sql
INSERT INTO entraid.identity.conditional_access_deleted_items_named_locations (
deletedDateTime,
@odata.type,
createdDateTime,
displayName,
...
```sql
UPDATE entraid.identity.conditional_access_deleted_items_named_locations
SET 
...
```sql
DELETE FROM entraid.identity.conditional_access_deleted_items_named_locations
WHERE namedLocation-id = '{{ namedLocation-id }}' --required
...
```sql
EXEC entraid.identity.conditional_access_deleted_items_named_locations.restore 
@namedLocation-id='{{ namedLocation-id }}' --required
;
```
</TabItem>
