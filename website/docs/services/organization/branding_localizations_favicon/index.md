...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.organization.branding_localizations_favicon" /></td></tr>
</tbody></table>
...
```sql
REPLACE entraid.organization.branding_localizations_favicon
SET 
...
```sql
DELETE FROM entraid.organization.branding_localizations_favicon
