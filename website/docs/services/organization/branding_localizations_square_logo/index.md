...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.organization.branding_localizations_square_logo" /></td></tr>
</tbody></table>
...
```sql
REPLACE entraid.organization.branding_localizations_square_logo
SET 
...
```sql
DELETE FROM entraid.organization.branding_localizations_square_logo
