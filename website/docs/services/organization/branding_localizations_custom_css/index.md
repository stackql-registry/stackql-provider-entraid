...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.organization.branding_localizations_custom_css" /></td></tr>
</tbody></table>
...
```sql
REPLACE entraid.organization.branding_localizations_custom_css
SET 
...
```sql
DELETE FROM entraid.organization.branding_localizations_custom_css
