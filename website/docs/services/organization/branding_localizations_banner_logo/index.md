...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.organization.branding_localizations_banner_logo" /></td></tr>
</tbody></table>
...
```sql
REPLACE entraid.organization.branding_localizations_banner_logo
SET 
...
```sql
DELETE FROM entraid.organization.branding_localizations_banner_logo
