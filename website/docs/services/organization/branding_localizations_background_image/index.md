...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.organization.branding_localizations_background_image" /></td></tr>
</tbody></table>
...
```sql
REPLACE entraid.organization.branding_localizations_background_image
SET 
...
```sql
DELETE FROM entraid.organization.branding_localizations_background_image
