...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.organization.branding_header_logo" /></td></tr>
</tbody></table>
...
```sql
REPLACE entraid.organization.branding_header_logo
SET 
...
```sql
DELETE FROM entraid.organization.branding_header_logo
