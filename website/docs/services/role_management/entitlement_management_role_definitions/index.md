--- 
title: entitlement_management_role_definitions
hide_title: false
...
Creates, updates, deletes, gets or lists an <code>entitlement_management_role_definitions</code> resource.
...
- name: entitlement_management_role_definitions
  props:
    - name: id
      value: "{{ id }}"
      description: |
