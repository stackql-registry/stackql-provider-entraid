--- 
title: directory_role_assignment_schedules
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>directory_role_assignment_schedules</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="directory_role_assignment_schedules" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.role_management.directory_role_assignment_schedules" /></td></tr>
</tbody></table>
...
scheduleInfo,
status
FROM entraid.role_management.directory_role_assignment_schedules
...
```sql
INSERT INTO entraid.role_management.directory_role_assignment_schedules (
id,
@odata.type,
appScopeId,
createdDateTime,
...
- name: directory_role_assignment_schedules
  props:
    - name: id
      value: "{{ id }}"
      description: |
...
```sql
UPDATE entraid.role_management.directory_role_assignment_schedules
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.role_management.directory_role_assignment_schedules
WHERE unifiedRoleAssignmentSchedule-id = '{{ unifiedRoleAssignmentSchedule-id }}' --required
