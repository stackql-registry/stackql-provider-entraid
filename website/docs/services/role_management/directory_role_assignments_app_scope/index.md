--- 
title: directory_role_assignments_app_scope
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>directory_role_assignments_app_scope</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="directory_role_assignments_app_scope" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.role_management.directory_role_assignments_app_scope" /></td></tr>
</tbody></table>
...
displayName,
type
FROM entraid.role_management.directory_role_assignments_app_scope
...
```sql
UPDATE entraid.role_management.directory_role_assignments_app_scope
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.role_management.directory_role_assignments_app_scope
WHERE unifiedRoleAssignment-id = '{{ unifiedRoleAssignment-id }}' --required
