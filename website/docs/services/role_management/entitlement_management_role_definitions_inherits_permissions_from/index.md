...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.role_management.entitlement_management_role_definitions_inherits_permissions_from" /></td></tr>
</tbody></table>
...
templateId,
version
FROM entraid.role_management.entitlement_management_role_definitions_inherits_permissions_from
...
```sql
INSERT INTO entraid.role_management.entitlement_management_role_definitions_inherits_permissions_from (
id,
@odata.type,
description,
displayName,
...
```sql
UPDATE entraid.role_management.entitlement_management_role_definitions_inherits_permissions_from
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
description = '{{ description }}',
...
```sql
DELETE FROM entraid.role_management.entitlement_management_role_definitions_inherits_permissions_from
WHERE unifiedRoleDefinition-id = '{{ unifiedRoleDefinition-id }}' --required
AND unifiedRoleDefinition-id1 = '{{ unifiedRoleDefinition-id1 }}' --required
