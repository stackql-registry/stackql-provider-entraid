--- 
title: directory_resource_namespaces
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>directory_resource_namespaces</code> resource.
...
- name: directory_resource_namespaces
  props:
    - name: id
      value: "{{ id }}"
      description: |
