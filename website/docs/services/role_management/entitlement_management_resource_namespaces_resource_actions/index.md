...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.role_management.entitlement_management_resource_namespaces_resource_actions" /></td></tr>
</tbody></table>
...
resourceScopeId
FROM entraid.role_management.entitlement_management_resource_namespaces_resource_actions
...
```sql
INSERT INTO entraid.role_management.entitlement_management_resource_namespaces_resource_actions (
id,
@odata.type,
actionVerb,
authenticationContextId,
...
```sql
UPDATE entraid.role_management.entitlement_management_resource_namespaces_resource_actions
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.role_management.entitlement_management_resource_namespaces_resource_actions
WHERE unifiedRbacResourceNamespace-id = '{{ unifiedRbacResourceNamespace-id }}' --required
AND unifiedRbacResourceAction-id = '{{ unifiedRbacResourceAction-id }}' --required
