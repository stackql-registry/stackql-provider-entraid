...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.role_management.directory_role_eligibility_schedules" /></td></tr>
</tbody></table>
...
scheduleInfo,
status
FROM entraid.role_management.directory_role_eligibility_schedules
...
```sql
INSERT INTO entraid.role_management.directory_role_eligibility_schedules (
id,
@odata.type,
appScopeId,
createdDateTime,
...
```sql
UPDATE entraid.role_management.directory_role_eligibility_schedules
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.role_management.directory_role_eligibility_schedules
WHERE unifiedRoleEligibilitySchedule-id = '{{ unifiedRoleEligibilitySchedule-id }}' --required
