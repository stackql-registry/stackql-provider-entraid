...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.role_management.directory_role_assignment_schedule_instances" /></td></tr>
</tbody></table>
...
roleDefinitionId,
startDateTime
FROM entraid.role_management.directory_role_assignment_schedule_instances
...
```sql
INSERT INTO entraid.role_management.directory_role_assignment_schedule_instances (
id,
@odata.type,
appScopeId,
directoryScopeId,
...
```sql
UPDATE entraid.role_management.directory_role_assignment_schedule_instances
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.role_management.directory_role_assignment_schedule_instances
WHERE unifiedRoleAssignmentScheduleInstance-id = '{{ unifiedRoleAssignmentScheduleInstance-id }}' --required
