--- 
title: directory_role_eligibility_schedule_instances
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>directory_role_eligibility_schedule_instances</code> resource.
...
<tr>
    ...
    <td>Get the instance of a role eligibility.</td>
</tr>
<tr>
    ...
    <td>Get the instances of role eligibilities.</td>
</tr>
<tr>
...
- name: directory_role_eligibility_schedule_instances
  props:
    - name: id
      value: "{{ id }}"
      description: |
