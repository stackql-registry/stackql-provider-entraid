--- 
title: directory_role_assignments
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>directory_role_assignments</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="directory_role_assignments" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.role_management.directory_role_assignments" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Retrieve the properties and relationships of a unifiedRoleAssignment object.</td>
</tr>
<tr>
...
<tr>
    ...
    <td>Delete a unifiedRoleAssignment object.</td>
</tr>
</tbody>
</table>
...
roleDefinition,
roleDefinitionId
FROM entraid.role_management.directory_role_assignments
...
```sql
INSERT INTO entraid.role_management.directory_role_assignments (
id,
@odata.type,
appScopeId,
condition,
...
```sql
UPDATE entraid.role_management.directory_role_assignments
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.role_management.directory_role_assignments
WHERE unifiedRoleAssignment-id = '{{ unifiedRoleAssignment-id }}' --required
