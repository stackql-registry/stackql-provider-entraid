--- 
title: entitlement_management_resource_namespaces
hide_title: false
...
Creates, updates, deletes, gets or lists an <code>entitlement_management_resource_namespaces</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="entitlement_management_resource_namespaces" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.role_management.entitlement_management_resource_namespaces" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="resourceActions" /></td>
...
@odata.type,
resourceActions
FROM entraid.role_management.entitlement_management_resource_namespaces
...
```sql
INSERT INTO entraid.role_management.entitlement_management_resource_namespaces (
id,
@odata.type,
name,
resourceActions
...
```sql
UPDATE entraid.role_management.entitlement_management_resource_namespaces
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
name = '{{ name }}',
...
```sql
DELETE FROM entraid.role_management.entitlement_management_resource_namespaces
WHERE unifiedRbacResourceNamespace-id = '{{ unifiedRbacResourceNamespace-id }}' --required
