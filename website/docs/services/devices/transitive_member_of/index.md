...
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.devices.transitive_member_of" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Get the groups and administrative units that the device is a member of. This API request is transitive, and will also return all groups and administrative units the device is a nested member of.</td>
</tr>
</tbody>
</table>
...
@odata.type,
deletedDateTime
FROM entra_id.devices.transitive_member_of
