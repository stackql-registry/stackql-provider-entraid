--- 
title: invited_user_mailbox_settings
hide_title: false
hide_table_of_contents: false
keywords:
  - invited_user_mailbox_settings
  - invitations
  - entraid
...
Creates, updates, deletes, gets or lists an <code>invited_user_mailbox_settings</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="invited_user_mailbox_settings" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.invitations.invited_user_mailbox_settings" /></td></tr>
</tbody></table>
...
userPurpose,
workingHours
FROM entraid.invitations.invited_user_mailbox_settings
WHERE $select = '{{ $select }}'
AND $expand = '{{ $expand }}'
;
```
...
```sql
UPDATE entraid.invitations.invited_user_mailbox_settings
SET 
