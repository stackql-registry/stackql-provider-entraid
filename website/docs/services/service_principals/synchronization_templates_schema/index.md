...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.service_principals.synchronization_templates_schema" /></td></tr>
</tbody></table>
...
version
FROM entraid.service_principals.synchronization_templates_schema
...
```sql
UPDATE entraid.service_principals.synchronization_templates_schema
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.service_principals.synchronization_templates_schema
WHERE servicePrincipal-id = '{{ servicePrincipal-id }}' --required
AND synchronizationTemplate-id = '{{ synchronizationTemplate-id }}' --required
