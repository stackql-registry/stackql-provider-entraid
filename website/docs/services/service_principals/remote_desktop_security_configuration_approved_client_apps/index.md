--- 
title: remote_desktop_security_configuration_approved_client_apps
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>remote_desktop_security_configuration_approved_client_apps</code> resource.
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The display name of the approved client application.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-servicePrincipal-id"><code>servicePrincipal-id</code></a>, <a href="#parameter-approvedClientApp-id"><code>approvedClientApp-id</code></a></td>
    <td><a href="#parameter-$select"><code>$select</code></a>, <a href="#parameter-$expand"><code>$expand</code></a></td>
    <td>Read the properties and relationships of a approvedClientApp object for the remoteDesktopSecurityConfiguration object on a servicePrincipal.</td>
</tr>
<tr>
...
<tr>
    ...
    <td></td>
    <td>Create a new approvedClientApp object for the remoteDesktopSecurityConfiguration object on a service principal. You can configure a maximum of 20 approved client apps.</td>
</tr>
<tr>
    <td><a href="#update"><CopyableCode code="update" /></a></td>
    <td><CopyableCode code="update" /></td>
    <td><a href="#parameter-servicePrincipal-id"><code>servicePrincipal-id</code></a>, <a href="#parameter-approvedClientApp-id"><code>approvedClientApp-id</code></a>, <a href="#parameter-@odata.type"><code>@odata.type</code></a></td>
    <td></td>
    <td>Update the properties of an approvedClientApp object for a remotedesktopsecurityconfiguration.</td>
</tr>
<tr>
...
<tbody>
<tr id="parameter-approvedClientApp-id">
    <td><CopyableCode code="approvedClientApp-id" /></td>
    <td><code>string</code></td>
    <td>The unique identifier of approvedClientApp</td>
</tr>
