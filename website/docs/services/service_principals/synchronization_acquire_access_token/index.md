...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.service_principals.synchronization_acquire_access_token" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO entraid.service_principals.synchronization_acquire_access_token (
credentials,
servicePrincipal-id
)
SELECT 
