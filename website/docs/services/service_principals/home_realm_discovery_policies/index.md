...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.service_principals.home_realm_discovery_policies" /></td></tr>
</tbody></table>
...
FROM entraid.service_principals.home_realm_discovery_policies
...
```sql
INSERT INTO entraid.service_principals.home_realm_discovery_policies (
@odata.id,
servicePrincipal-id
)
SELECT 
...
```sql
DELETE FROM entraid.service_principals.home_realm_discovery_policies
WHERE servicePrincipal-id = '{{ servicePrincipal-id }}' --required
