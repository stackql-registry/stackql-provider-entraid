--- 
title: authentication_flows_policy
hide_title: false
...
Creates, updates, deletes, gets or lists an <code>authentication_flows_policy</code> resource.
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Inherited property. The human-readable name of the policy. Optional. Read-only.</td>
</tr>
<tr>
    <td><CopyableCode code="selfServiceSignUp" /></td>
    <td><code></code></td>
    <td>Contains selfServiceSignUpAuthenticationFlowConfiguration settings that convey whether self-service sign-up is enabled or disabled. Optional. Read-only.</td>
</tr>
</tbody>
</table>
</TabItem>
