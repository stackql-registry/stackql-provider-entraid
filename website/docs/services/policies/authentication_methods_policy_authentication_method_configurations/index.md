...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.policies.authentication_methods_policy_authentication_method_configurations" /></td></tr>
</tbody></table>
...
excludeTargets,
state
FROM entraid.policies.authentication_methods_policy_authentication_method_configurations
...
```sql
INSERT INTO entraid.policies.authentication_methods_policy_authentication_method_configurations (
id,
@odata.type,
excludeTargets,
state
...
```sql
UPDATE entraid.policies.authentication_methods_policy_authentication_method_configurations
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
...
```sql
DELETE FROM entraid.policies.authentication_methods_policy_authentication_method_configurations
WHERE authenticationMethodConfiguration-id = '{{ authenticationMethodConfiguration-id }}' --required
