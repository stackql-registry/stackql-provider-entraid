...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.policies.token_lifetime_policies" /></td></tr>
</tbody></table>
...
FROM entraid.policies.token_lifetime_policies
...
```sql
INSERT INTO entraid.policies.token_lifetime_policies (
id,
@odata.type,
deletedDateTime,
description,
...
```sql
UPDATE entraid.policies.token_lifetime_policies
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
deletedDateTime = '{{ deletedDateTime }}',
...
```sql
DELETE FROM entraid.policies.token_lifetime_policies
WHERE tokenLifetimePolicy-id = '{{ tokenLifetimePolicy-id }}' --required
