...
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.policies.token_lifetime_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-tokenLifetimePolicy-id"><code>tokenLifetimePolicy-id</code></a></td>
    <td><a href="#parameter-$select"><code>$select</code></a>, <a href="#parameter-$expand"><code>$expand</code></a></td>
    <td>Retrieve the properties and relationships of a tokenLifetimePolicy object.</td>
</tr>
<tr>
    ...
    <td>Get a list of tokenLifetimePolicy objects.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Create a new tokenLifetimePolicy object.</td>
</tr>
<tr>
    <td><a href="#update"><CopyableCode code="update" /></a></td>
    <td><CopyableCode code="update" /></td>
    <td><a href="#parameter-tokenLifetimePolicy-id"><code>tokenLifetimePolicy-id</code></a>, <a href="#parameter-@odata.type"><code>@odata.type</code></a></td>
    <td></td>
    <td>Update the properties of a tokenLifetimePolicy object.</td>
</tr>
<tr>
    ...
    <td>Delete a tokenLifetimePolicy object.</td>
</tr>
</tbody>
</table>
...
FROM entra_id.policies.token_lifetime_policies
WHERE tokenLifetimePolicy-id = '{{ tokenLifetimePolicy-id }}' -- required
AND $select = '{{ $select }}'
AND $expand = '{{ $expand }}'
;
```
...
```sql
INSERT INTO entra_id.policies.token_lifetime_policies (
id,
@odata.type,
deletedDateTime,
description,
...
```sql
UPDATE entra_id.policies.token_lifetime_policies
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
deletedDateTime = '{{ deletedDateTime }}',
...
appliesTo = '{{ appliesTo }}'
WHERE 
tokenLifetimePolicy-id = '{{ tokenLifetimePolicy-id }}' --required
...
```sql
DELETE FROM entra_id.policies.token_lifetime_policies
WHERE tokenLifetimePolicy-id = '{{ tokenLifetimePolicy-id }}' --required
