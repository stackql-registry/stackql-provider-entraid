...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.policies.conditional_access_policies" /></td></tr>
</tbody></table>
...
state,
templateId
FROM entraid.policies.conditional_access_policies
...
```sql
INSERT INTO entraid.policies.conditional_access_policies (
deletedDateTime,
@odata.type,
conditions,
createdDateTime,
...
```sql
UPDATE entraid.policies.conditional_access_policies
SET 
...
```sql
DELETE FROM entraid.policies.conditional_access_policies
WHERE conditionalAccessPolicy-id = '{{ conditionalAccessPolicy-id }}' --required
...
```sql
EXEC entraid.policies.conditional_access_policies.restore 
@conditionalAccessPolicy-id='{{ conditionalAccessPolicy-id }}' --required
;
```
</TabItem>
