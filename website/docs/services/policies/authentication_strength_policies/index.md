...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.policies.authentication_strength_policies" /></td></tr>
</tbody></table>
...
FROM entraid.policies.authentication_strength_policies
...
```sql
INSERT INTO entraid.policies.authentication_strength_policies (
id,
@odata.type,
allowedCombinations,
createdDateTime,
...
```sql
UPDATE entraid.policies.authentication_strength_policies
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
...
```sql
DELETE FROM entraid.policies.authentication_strength_policies
WHERE authenticationStrengthPolicy-id = '{{ authenticationStrengthPolicy-id }}' --required
...
```sql
EXEC entraid.policies.authentication_strength_policies.update_allowed_combinations 
@authenticationStrengthPolicy-id='{{ authenticationStrengthPolicy-id }}' --required 
@@json=
'{
"allowedCombinations": "{{ allowedCombinations }}"
