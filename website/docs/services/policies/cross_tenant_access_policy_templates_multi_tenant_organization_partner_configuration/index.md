...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.policies.cross_tenant_access_policy_templates_multi_tenant_organization_partner_configuration" /></td></tr>
</tbody></table>
...
FROM entraid.policies.cross_tenant_access_policy_templates_multi_tenant_organization_partner_configuration
WHERE $select = '{{ $select }}'
AND $expand = '{{ $expand }}'
;
```
...
```sql
UPDATE entraid.policies.cross_tenant_access_policy_templates_multi_tenant_organization_partner_configuration
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.policies.cross_tenant_access_policy_templates_multi_tenant_organization_partner_configuration
