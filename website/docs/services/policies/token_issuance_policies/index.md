...
Creates, updates, deletes, gets or lists a <code>token_issuance_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="token_issuance_policies" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.policies.token_issuance_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-tokenIssuancePolicy-id"><code>tokenIssuancePolicy-id</code></a></td>
...
<tr>
    ...
    <td>Get a list of tokenIssuancePolicy objects.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Create a new tokenIssuancePolicy object.</td>
</tr>
<tr>
    <td><a href="#update"><CopyableCode code="update" /></a></td>
    <td><CopyableCode code="update" /></td>
    <td><a href="#parameter-tokenIssuancePolicy-id"><code>tokenIssuancePolicy-id</code></a>, <a href="#parameter-@odata.type"><code>@odata.type</code></a></td>
    <td></td>
    <td>Update the properties of a tokenIssuancePolicy object.</td>
</tr>
<tr>
    ...
    <td>Delete a tokenIssuancePolicy object.</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr id="parameter-tokenIssuancePolicy-id">
    <td><CopyableCode code="tokenIssuancePolicy-id" /></td>
    <td><code>string</code></td>
    <td>The unique identifier of tokenIssuancePolicy</td>
</tr>
...
FROM entraid.policies.token_issuance_policies
...
```sql
INSERT INTO entraid.policies.token_issuance_policies (
id,
@odata.type,
deletedDateTime,
description,
...
```sql
UPDATE entraid.policies.token_issuance_policies
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
deletedDateTime = '{{ deletedDateTime }}',
...
appliesTo = '{{ appliesTo }}'
WHERE 
tokenIssuancePolicy-id = '{{ tokenIssuancePolicy-id }}' --required
...
```sql
DELETE FROM entraid.policies.token_issuance_policies
WHERE tokenIssuancePolicy-id = '{{ tokenIssuancePolicy-id }}' --required
