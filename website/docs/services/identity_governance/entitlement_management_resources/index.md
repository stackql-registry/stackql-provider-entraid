...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.entitlement_management_resources" /></td></tr>
</tbody></table>
...
roles,
scopes
FROM entraid.identity_governance.entitlement_management_resources
...
```sql
INSERT INTO entraid.identity_governance.entitlement_management_resources (
id,
@odata.type,
attributes,
createdDateTime,
...
```sql
UPDATE entraid.identity_governance.entitlement_management_resources
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
...
```sql
DELETE FROM entraid.identity_governance.entitlement_management_resources
WHERE accessPackageResource-id = '{{ accessPackageResource-id }}' --required
...
```sql
EXEC entraid.identity_governance.entitlement_management_resources.refresh 
@accessPackageResource-id='{{ accessPackageResource-id }}' --required
;
```
</TabItem>
