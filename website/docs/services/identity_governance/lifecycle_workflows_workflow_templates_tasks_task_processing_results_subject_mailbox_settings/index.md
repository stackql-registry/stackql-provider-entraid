--- 
title: lifecycle_workflows_workflow_templates_tasks_task_processing_results_subject_mailbox_settings
hide_title: false
hide_table_of_contents: false
keywords:
  - lifecycle_workflows_workflow_templates_tasks_task_processing_results_subject_mailbox_settings
  - identity_governance
  - entra_id
...
Creates, updates, deletes, gets or lists a <code>lifecycle_workflows_workflow_templates_tasks_task_processing_results_subject_mailbox_settings</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="lifecycle_workflows_workflow_templates_tasks_task_processing_results_subject_mailbox_settings" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.identity_governance.lifecycle_workflows_workflow_templates_tasks_task_processing_results_subject_mailbox_settings" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-workflowTemplate-id"><code>workflowTemplate-id</code></a>, <a href="#parameter-task-id"><code>task-id</code></a>, <a href="#parameter-taskProcessingResult-id"><code>taskProcessingResult-id</code></a></td>
...
<tr>
    ...
    <td><a href="#parameter-workflowTemplate-id"><code>workflowTemplate-id</code></a>, <a href="#parameter-task-id"><code>task-id</code></a>, <a href="#parameter-taskProcessingResult-id"><code>taskProcessingResult-id</code></a>, <a href="#parameter-@odata.type"><code>@odata.type</code></a></td>
    <td></td>
    <td></td>
</tr>
</tbody>
...
<tr id="parameter-workflowTemplate-id">
    <td><CopyableCode code="workflowTemplate-id" /></td>
    <td><code>string</code></td>
...
userPurpose,
workingHours
FROM entra_id.identity_governance.lifecycle_workflows_workflow_templates_tasks_task_processing_results_subject_mailbox_settings
WHERE workflowTemplate-id = '{{ workflowTemplate-id }}' -- required
...
```sql
UPDATE entra_id.identity_governance.lifecycle_workflows_workflow_templates_tasks_task_processing_results_subject_mailbox_settings
SET 
...
WHERE 
workflowTemplate-id = '{{ workflowTemplate-id }}' --required
AND task-id = '{{ task-id }}' --required
AND taskProcessingResult-id = '{{ taskProcessingResult-id }}' --required
