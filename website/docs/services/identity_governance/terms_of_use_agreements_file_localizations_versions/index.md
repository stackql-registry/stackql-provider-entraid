...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.terms_of_use_agreements_file_localizations_versions" /></td></tr>
</tbody></table>
...
isMajorVersion,
language
FROM entraid.identity_governance.terms_of_use_agreements_file_localizations_versions
...
```sql
INSERT INTO entraid.identity_governance.terms_of_use_agreements_file_localizations_versions (
id,
@odata.type,
createdDateTime,
displayName,
...
```sql
UPDATE entraid.identity_governance.terms_of_use_agreements_file_localizations_versions
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.identity_governance.terms_of_use_agreements_file_localizations_versions
WHERE agreement-id = '{{ agreement-id }}' --required
AND agreementFileLocalization-id = '{{ agreementFileLocalization-id }}' --required
AND agreementFileVersion-id = '{{ agreementFileVersion-id }}' --required
