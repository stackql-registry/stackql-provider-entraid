...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.entitlement_management_access_packages_resource_role_scopes_role_resource_scopes_resource" /></td></tr>
</tbody></table>
...
roles,
scopes
FROM entraid.identity_governance.entitlement_management_access_packages_resource_role_scopes_role_resource_scopes_resource
...
```sql
UPDATE entraid.identity_governance.entitlement_management_access_packages_resource_role_scopes_role_resource_scopes_resource
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.identity_governance.entitlement_management_access_packages_resource_role_scopes_role_resource_scopes_resource
WHERE accessPackage-id = '{{ accessPackage-id }}' --required
AND accessPackageResourceRoleScope-id = '{{ accessPackageResourceRoleScope-id }}' --required
AND accessPackageResourceScope-id = '{{ accessPackageResourceScope-id }}' --required
...
```sql
EXEC entraid.identity_governance.entitlement_management_access_packages_resource_role_scopes_role_resource_scopes_resource.refresh 
@accessPackage-id='{{ accessPackage-id }}' --required, 
