...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.terms_of_use_agreements_file_localizations" /></td></tr>
</tbody></table>
...
language,
versions
FROM entraid.identity_governance.terms_of_use_agreements_file_localizations
...
```sql
INSERT INTO entraid.identity_governance.terms_of_use_agreements_file_localizations (
id,
@odata.type,
createdDateTime,
displayName,
...
```sql
UPDATE entraid.identity_governance.terms_of_use_agreements_file_localizations
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
createdDateTime = '{{ createdDateTime }}',
...
```sql
DELETE FROM entraid.identity_governance.terms_of_use_agreements_file_localizations
WHERE agreement-id = '{{ agreement-id }}' --required
AND agreementFileLocalization-id = '{{ agreementFileLocalization-id }}' --required
