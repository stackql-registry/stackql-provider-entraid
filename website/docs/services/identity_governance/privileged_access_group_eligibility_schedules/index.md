...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.privileged_access_group_eligibility_schedules" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-privilegedAccessGroupEligibilitySchedule-id"><code>privilegedAccessGroupEligibilitySchedule-id</code></a>, <a href="#parameter-@odata.type"><code>@odata.type</code></a></td>
    <td></td>
    <td></td>
</tr>
<tr>
...
scheduleInfo,
status
FROM entraid.identity_governance.privileged_access_group_eligibility_schedules
...
```sql
INSERT INTO entraid.identity_governance.privileged_access_group_eligibility_schedules (
id,
@odata.type,
createdDateTime,
createdUsing,
...
```sql
UPDATE entraid.identity_governance.privileged_access_group_eligibility_schedules
SET 
id = '{{ id }}',
...
principal = '{{ principal }}'
WHERE 
privilegedAccessGroupEligibilitySchedule-id = '{{ privilegedAccessGroupEligibilitySchedule-id }}' --required
...
```sql
DELETE FROM entraid.identity_governance.privileged_access_group_eligibility_schedules
WHERE privilegedAccessGroupEligibilitySchedule-id = '{{ privilegedAccessGroupEligibilitySchedule-id }}' --required
