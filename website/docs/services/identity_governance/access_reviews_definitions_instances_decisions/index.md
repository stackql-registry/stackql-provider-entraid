--- 
title: access_reviews_definitions_instances_decisions
hide_title: false
...
Creates, updates, deletes, gets or lists an <code>access_reviews_definitions_instances_decisions</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="access_reviews_definitions_instances_decisions" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.access_reviews_definitions_instances_decisions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Retrieve the accessReviewInstanceDecisionItem objects for a specific accessReviewInstance. A list of zero or more accessReviewInstanceDecisionItem objects are returned, including all of their nested properties.</td>
</tr>
<tr>
...
reviewedBy,
reviewedDateTime
FROM entraid.identity_governance.access_reviews_definitions_instances_decisions
...
```sql
INSERT INTO entraid.identity_governance.access_reviews_definitions_instances_decisions (
id,
@odata.type,
accessReviewId,
appliedBy,
...
```sql
UPDATE entraid.identity_governance.access_reviews_definitions_instances_decisions
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
...
```sql
DELETE FROM entraid.identity_governance.access_reviews_definitions_instances_decisions
WHERE accessReviewScheduleDefinition-id = '{{ accessReviewScheduleDefinition-id }}' --required
AND accessReviewInstance-id = '{{ accessReviewInstance-id }}' --required
AND accessReviewInstanceDecisionItem-id = '{{ accessReviewInstanceDecisionItem-id }}' --required
