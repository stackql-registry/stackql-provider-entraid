--- 
title: terms_of_use_agreements_files
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>terms_of_use_agreements_files</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="terms_of_use_agreements_files" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.terms_of_use_agreements_files" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Create a new localized agreement file.</td>
</tr>
<tr>
...
language,
versions
FROM entraid.identity_governance.terms_of_use_agreements_files
...
```sql
INSERT INTO entraid.identity_governance.terms_of_use_agreements_files (
id,
@odata.type,
createdDateTime,
displayName,
...
```sql
UPDATE entraid.identity_governance.terms_of_use_agreements_files
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
createdDateTime = '{{ createdDateTime }}',
...
```sql
DELETE FROM entraid.identity_governance.terms_of_use_agreements_files
WHERE agreement-id = '{{ agreement-id }}' --required
AND agreementFileLocalization-id = '{{ agreementFileLocalization-id }}' --required
