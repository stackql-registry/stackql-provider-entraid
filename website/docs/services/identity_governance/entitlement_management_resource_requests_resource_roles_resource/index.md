...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.entitlement_management_resource_requests_resource_roles_resource" /></td></tr>
</tbody></table>
...
roles,
scopes
FROM entraid.identity_governance.entitlement_management_resource_requests_resource_roles_resource
...
```sql
UPDATE entraid.identity_governance.entitlement_management_resource_requests_resource_roles_resource
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.identity_governance.entitlement_management_resource_requests_resource_roles_resource
WHERE accessPackageResourceRequest-id = '{{ accessPackageResourceRequest-id }}' --required
AND accessPackageResourceRole-id = '{{ accessPackageResourceRole-id }}' --required
...
```sql
EXEC entraid.identity_governance.entitlement_management_resource_requests_resource_roles_resource.refresh 
@accessPackageResourceRequest-id='{{ accessPackageResourceRequest-id }}' --required, 
