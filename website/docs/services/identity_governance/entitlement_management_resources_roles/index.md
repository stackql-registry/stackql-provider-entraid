...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.entitlement_management_resources_roles" /></td></tr>
</tbody></table>
...
originSystem,
resource
FROM entraid.identity_governance.entitlement_management_resources_roles
...
```sql
INSERT INTO entraid.identity_governance.entitlement_management_resources_roles (
id,
@odata.type,
description,
displayName,
...
```sql
UPDATE entraid.identity_governance.entitlement_management_resources_roles
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.identity_governance.entitlement_management_resources_roles
WHERE accessPackageResource-id = '{{ accessPackageResource-id }}' --required
AND accessPackageResourceRole-id = '{{ accessPackageResourceRole-id }}' --required
