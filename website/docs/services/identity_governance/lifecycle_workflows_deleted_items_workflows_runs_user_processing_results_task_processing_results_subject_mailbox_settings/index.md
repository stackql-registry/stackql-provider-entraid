--- 
title: lifecycle_workflows_deleted_items_workflows_runs_user_processing_results_task_processing_results_subject_mailbox_settings
hide_title: false
hide_table_of_contents: false
keywords:
  - lifecycle_workflows_deleted_items_workflows_runs_user_processing_results_task_processing_results_subject_mailbox_settings
  - identity_governance
  - entra_id
...
Creates, updates, deletes, gets or lists a <code>lifecycle_workflows_deleted_items_workflows_runs_user_processing_results_task_processing_results_subject_mailbox_settings</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="lifecycle_workflows_deleted_items_workflows_runs_user_processing_results_task_processing_results_subject_mailbox_settings" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.identity_governance.lifecycle_workflows_deleted_items_workflows_runs_user_processing_results_task_processing_results_subject_mailbox_settings" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-workflow-id"><code>workflow-id</code></a>, <a href="#parameter-run-id"><code>run-id</code></a>, <a href="#parameter-userProcessingResult-id"><code>userProcessingResult-id</code></a>, <a href="#parameter-taskProcessingResult-id"><code>taskProcessingResult-id</code></a></td>
...
<tr>
    ...
    <td><a href="#parameter-workflow-id"><code>workflow-id</code></a>, <a href="#parameter-run-id"><code>run-id</code></a>, <a href="#parameter-userProcessingResult-id"><code>userProcessingResult-id</code></a>, <a href="#parameter-taskProcessingResult-id"><code>taskProcessingResult-id</code></a>, <a href="#parameter-@odata.type"><code>@odata.type</code></a></td>
    <td></td>
    <td></td>
</tr>
</tbody>
...
userPurpose,
workingHours
FROM entra_id.identity_governance.lifecycle_workflows_deleted_items_workflows_runs_user_processing_results_task_processing_results_subject_mailbox_settings
...
```sql
UPDATE entra_id.identity_governance.lifecycle_workflows_deleted_items_workflows_runs_user_processing_results_task_processing_results_subject_mailbox_settings
SET 
