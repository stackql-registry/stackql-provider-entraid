...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.privileged_access_group_assignment_schedule_instances" /></td></tr>
</tbody></table>
...
principalId,
startDateTime
FROM entraid.identity_governance.privileged_access_group_assignment_schedule_instances
...
```sql
INSERT INTO entraid.identity_governance.privileged_access_group_assignment_schedule_instances (
id,
@odata.type,
endDateTime,
startDateTime,
...
```sql
UPDATE entraid.identity_governance.privileged_access_group_assignment_schedule_instances
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.identity_governance.privileged_access_group_assignment_schedule_instances
WHERE privilegedAccessGroupAssignmentScheduleInstance-id = '{{ privilegedAccessGroupAssignmentScheduleInstance-id }}' --required
