--- 
title: privileged_access_group_assignment_approvals
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>privileged_access_group_assignment_approvals</code> resource.
...
- name: privileged_access_group_assignment_approvals
  props:
    - name: id
      value: "{{ id }}"
      description: |
