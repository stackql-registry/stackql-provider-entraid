...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.entitlement_management_access_packages_resource_role_scopes_role_resource_roles" /></td></tr>
</tbody></table>
...
originSystem,
resource
FROM entraid.identity_governance.entitlement_management_access_packages_resource_role_scopes_role_resource_roles
...
```sql
INSERT INTO entraid.identity_governance.entitlement_management_access_packages_resource_role_scopes_role_resource_roles (
id,
@odata.type,
description,
displayName,
...
```sql
UPDATE entraid.identity_governance.entitlement_management_access_packages_resource_role_scopes_role_resource_roles
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.identity_governance.entitlement_management_access_packages_resource_role_scopes_role_resource_roles
WHERE accessPackage-id = '{{ accessPackage-id }}' --required
AND accessPackageResourceRoleScope-id = '{{ accessPackageResourceRoleScope-id }}' --required
AND accessPackageResourceRole-id = '{{ accessPackageResourceRole-id }}' --required
