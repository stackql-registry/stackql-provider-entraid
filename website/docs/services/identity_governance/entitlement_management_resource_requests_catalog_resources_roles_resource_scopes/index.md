--- 
title: entitlement_management_resource_requests_catalog_resources_roles_resource_scopes
hide_title: false
hide_table_of_contents: false
keywords:
  - entitlement_management_resource_requests_catalog_resources_roles_resource_scopes
  - identity_governance
  - entra_id
...
Creates, updates, deletes, gets or lists an <code>entitlement_management_resource_requests_catalog_resources_roles_resource_scopes</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="entitlement_management_resource_requests_catalog_resources_roles_resource_scopes" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.identity_governance.entitlement_management_resource_requests_catalog_resources_roles_resource_scopes" /></td></tr>
</tbody></table>
...
originSystem,
resource
FROM entra_id.identity_governance.entitlement_management_resource_requests_catalog_resources_roles_resource_scopes
...
```sql
INSERT INTO entra_id.identity_governance.entitlement_management_resource_requests_catalog_resources_roles_resource_scopes (
id,
@odata.type,
description,
displayName,
...
- name: entitlement_management_resource_requests_catalog_resources_roles_resource_scopes
  props:
    - name: accessPackageResourceRequest-id
      value: "{{ accessPackageResourceRequest-id }}"
      description: Required parameter for the entitlement_management_resource_requests_catalog_resources_roles_resource_scopes resource.
...
```sql
UPDATE entra_id.identity_governance.entitlement_management_resource_requests_catalog_resources_roles_resource_scopes
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entra_id.identity_governance.entitlement_management_resource_requests_catalog_resources_roles_resource_scopes
WHERE accessPackageResourceRequest-id = '{{ accessPackageResourceRequest-id }}' --required
AND accessPackageResource-id = '{{ accessPackageResource-id }}' --required
AND accessPackageResourceRole-id = '{{ accessPackageResourceRole-id }}' --required
AND accessPackageResourceScope-id = '{{ accessPackageResourceScope-id }}' --required
