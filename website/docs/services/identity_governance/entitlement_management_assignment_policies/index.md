...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.entitlement_management_assignment_policies" /></td></tr>
</tbody></table>
...
FROM entraid.identity_governance.entitlement_management_assignment_policies
...
```sql
INSERT INTO entraid.identity_governance.entitlement_management_assignment_policies (
id,
@odata.type,
allowedTargetScope,
automaticRequestSettings,
...
```sql
REPLACE entraid.identity_governance.entitlement_management_assignment_policies
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
...
```sql
DELETE FROM entraid.identity_governance.entitlement_management_assignment_policies
WHERE accessPackageAssignmentPolicy-id = '{{ accessPackageAssignmentPolicy-id }}' --required
