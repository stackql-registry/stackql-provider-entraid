...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.entitlement_management_resource_role_scopes_scope_resource" /></td></tr>
</tbody></table>
...
roles,
scopes
FROM entraid.identity_governance.entitlement_management_resource_role_scopes_scope_resource
...
```sql
UPDATE entraid.identity_governance.entitlement_management_resource_role_scopes_scope_resource
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.identity_governance.entitlement_management_resource_role_scopes_scope_resource
WHERE accessPackageResourceRoleScope-id = '{{ accessPackageResourceRoleScope-id }}' --required
...
```sql
EXEC entraid.identity_governance.entitlement_management_resource_role_scopes_scope_resource.refresh 
@accessPackageResourceRoleScope-id='{{ accessPackageResourceRoleScope-id }}' --required
;
```
</TabItem>
