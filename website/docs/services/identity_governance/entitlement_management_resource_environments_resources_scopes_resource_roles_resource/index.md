...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.entitlement_management_resource_environments_resources_scopes_resource_roles_resource" /></td></tr>
</tbody></table>
...
roles,
scopes
FROM entraid.identity_governance.entitlement_management_resource_environments_resources_scopes_resource_roles_resource
...
```sql
UPDATE entraid.identity_governance.entitlement_management_resource_environments_resources_scopes_resource_roles_resource
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.identity_governance.entitlement_management_resource_environments_resources_scopes_resource_roles_resource
WHERE accessPackageResourceEnvironment-id = '{{ accessPackageResourceEnvironment-id }}' --required
AND accessPackageResource-id = '{{ accessPackageResource-id }}' --required
AND accessPackageResourceScope-id = '{{ accessPackageResourceScope-id }}' --required
AND accessPackageResourceRole-id = '{{ accessPackageResourceRole-id }}' --required
...
```sql
EXEC entraid.identity_governance.entitlement_management_resource_environments_resources_scopes_resource_roles_resource.refresh 
@accessPackageResourceEnvironment-id='{{ accessPackageResourceEnvironment-id }}' --required, 
