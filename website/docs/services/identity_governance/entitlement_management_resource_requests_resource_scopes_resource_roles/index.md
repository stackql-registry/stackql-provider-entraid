--- 
title: entitlement_management_resource_requests_resource_scopes_resource_roles
hide_title: false
...
Creates, updates, deletes, gets or lists an <code>entitlement_management_resource_requests_resource_scopes_resource_roles</code> resource.
...
- name: entitlement_management_resource_requests_resource_scopes_resource_roles
  props:
    - name: accessPackageResourceRequest-id
      value: "{{ accessPackageResourceRequest-id }}"
      description: Required parameter for the entitlement_management_resource_requests_resource_scopes_resource_roles resource.
