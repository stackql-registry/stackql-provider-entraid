...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.entitlement_management_resource_requests_catalog" /></td></tr>
</tbody></table>
...
resources,
state
FROM entraid.identity_governance.entitlement_management_resource_requests_catalog
...
```sql
UPDATE entraid.identity_governance.entitlement_management_resource_requests_catalog
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.identity_governance.entitlement_management_resource_requests_catalog
WHERE accessPackageResourceRequest-id = '{{ accessPackageResourceRequest-id }}' --required
