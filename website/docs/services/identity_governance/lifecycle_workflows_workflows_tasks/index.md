...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.lifecycle_workflows_workflows_tasks" /></td></tr>
</tbody></table>
...
FROM entraid.identity_governance.lifecycle_workflows_workflows_tasks
...
```sql
INSERT INTO entraid.identity_governance.lifecycle_workflows_workflows_tasks (
id,
@odata.type,
arguments,
category,
...
```sql
UPDATE entraid.identity_governance.lifecycle_workflows_workflows_tasks
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
arguments = '{{ arguments }}',
...
```sql
DELETE FROM entraid.identity_governance.lifecycle_workflows_workflows_tasks
WHERE workflow-id = '{{ workflow-id }}' --required
AND task-id = '{{ task-id }}' --required
