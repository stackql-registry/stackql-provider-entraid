...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.privileged_access_group_eligibility_schedule_instances" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-privilegedAccessGroupEligibilityScheduleInstance-id"><code>privilegedAccessGroupEligibilityScheduleInstance-id</code></a>, <a href="#parameter-@odata.type"><code>@odata.type</code></a></td>
    <td></td>
    <td></td>
</tr>
<tr>
...
principalId,
startDateTime
FROM entraid.identity_governance.privileged_access_group_eligibility_schedule_instances
...
```sql
INSERT INTO entraid.identity_governance.privileged_access_group_eligibility_schedule_instances (
id,
@odata.type,
endDateTime,
startDateTime,
...
```sql
UPDATE entraid.identity_governance.privileged_access_group_eligibility_schedule_instances
SET 
id = '{{ id }}',
...
principal = '{{ principal }}'
WHERE 
privilegedAccessGroupEligibilityScheduleInstance-id = '{{ privilegedAccessGroupEligibilityScheduleInstance-id }}' --required
...
```sql
DELETE FROM entraid.identity_governance.privileged_access_group_eligibility_schedule_instances
WHERE privilegedAccessGroupEligibilityScheduleInstance-id = '{{ privilegedAccessGroupEligibilityScheduleInstance-id }}' --required
