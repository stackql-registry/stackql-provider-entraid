...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.lifecycle_workflows_settings" /></td></tr>
</tbody></table>
...
FROM entraid.identity_governance.lifecycle_workflows_settings
WHERE $select = '{{ $select }}'
AND $expand = '{{ $expand }}'
;
```
...
```sql
UPDATE entraid.identity_governance.lifecycle_workflows_settings
SET 
id = '{{ id }}',
