...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.entitlement_management_connected_organizations_internal_sponsors" /></td></tr>
</tbody></table>
...
@odata.type,
deletedDateTime
FROM entraid.identity_governance.entitlement_management_connected_organizations_internal_sponsors
...
```sql
INSERT INTO entraid.identity_governance.entitlement_management_connected_organizations_internal_sponsors (
@odata.id,
...
```sql
DELETE FROM entraid.identity_governance.entitlement_management_connected_organizations_internal_sponsors
WHERE connectedOrganization-id = '{{ connectedOrganization-id }}' --required
