...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.entitlement_management_resources_roles_resource_scopes_resource" /></td></tr>
</tbody></table>
...
roles,
scopes
FROM entraid.identity_governance.entitlement_management_resources_roles_resource_scopes_resource
...
```sql
UPDATE entraid.identity_governance.entitlement_management_resources_roles_resource_scopes_resource
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.identity_governance.entitlement_management_resources_roles_resource_scopes_resource
WHERE accessPackageResource-id = '{{ accessPackageResource-id }}' --required
AND accessPackageResourceRole-id = '{{ accessPackageResourceRole-id }}' --required
AND accessPackageResourceScope-id = '{{ accessPackageResourceScope-id }}' --required
...
```sql
EXEC entraid.identity_governance.entitlement_management_resources_roles_resource_scopes_resource.refresh 
@accessPackageResource-id='{{ accessPackageResource-id }}' --required, 
