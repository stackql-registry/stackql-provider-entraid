--- 
title: entitlement_management_resource_requests_catalog_resource_roles_resource_roles
hide_title: false
hide_table_of_contents: false
keywords:
  - entitlement_management_resource_requests_catalog_resource_roles_resource_roles
  - identity_governance
  - entra_id
...
Creates, updates, deletes, gets or lists an <code>entitlement_management_resource_requests_catalog_resource_roles_resource_roles</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="entitlement_management_resource_requests_catalog_resource_roles_resource_roles" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.identity_governance.entitlement_management_resource_requests_catalog_resource_roles_resource_roles" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-accessPackageResourceRequest-id"><code>accessPackageResourceRequest-id</code></a>, <a href="#parameter-accessPackageResourceRole-id"><code>accessPackageResourceRole-id</code></a>, <a href="#parameter-accessPackageResourceRole-id1"><code>accessPackageResourceRole-id1</code></a></td>
...
originSystem,
resource
FROM entra_id.identity_governance.entitlement_management_resource_requests_catalog_resource_roles_resource_roles
...
```sql
INSERT INTO entra_id.identity_governance.entitlement_management_resource_requests_catalog_resource_roles_resource_roles (
id,
@odata.type,
description,
displayName,
...
- name: entitlement_management_resource_requests_catalog_resource_roles_resource_roles
  props:
    - name: accessPackageResourceRequest-id
      value: "{{ accessPackageResourceRequest-id }}"
      description: Required parameter for the entitlement_management_resource_requests_catalog_resource_roles_resource_roles resource.
...
```sql
UPDATE entra_id.identity_governance.entitlement_management_resource_requests_catalog_resource_roles_resource_roles
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entra_id.identity_governance.entitlement_management_resource_requests_catalog_resource_roles_resource_roles
WHERE accessPackageResourceRequest-id = '{{ accessPackageResourceRequest-id }}' --required
AND accessPackageResourceRole-id = '{{ accessPackageResourceRole-id }}' --required
AND accessPackageResourceRole-id1 = '{{ accessPackageResourceRole-id1 }}' --required
