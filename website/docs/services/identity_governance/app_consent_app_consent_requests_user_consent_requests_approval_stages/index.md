...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.app_consent_app_consent_requests_user_consent_requests_approval_stages" /></td></tr>
</tbody></table>
...
reviewedDateTime,
status
FROM entraid.identity_governance.app_consent_app_consent_requests_user_consent_requests_approval_stages
...
```sql
INSERT INTO entraid.identity_governance.app_consent_app_consent_requests_user_consent_requests_approval_stages (
id,
@odata.type,
assignedToMe,
displayName,
...
```sql
UPDATE entraid.identity_governance.app_consent_app_consent_requests_user_consent_requests_approval_stages
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.identity_governance.app_consent_app_consent_requests_user_consent_requests_approval_stages
WHERE appConsentRequest-id = '{{ appConsentRequest-id }}' --required
AND userConsentRequest-id = '{{ userConsentRequest-id }}' --required
AND approvalStage-id = '{{ approvalStage-id }}' --required
