...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.entitlement_management_resource_requests_catalog_resource_scopes_resource" /></td></tr>
</tbody></table>
...
roles,
scopes
FROM entraid.identity_governance.entitlement_management_resource_requests_catalog_resource_scopes_resource
...
```sql
UPDATE entraid.identity_governance.entitlement_management_resource_requests_catalog_resource_scopes_resource
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.identity_governance.entitlement_management_resource_requests_catalog_resource_scopes_resource
WHERE accessPackageResourceRequest-id = '{{ accessPackageResourceRequest-id }}' --required
AND accessPackageResourceScope-id = '{{ accessPackageResourceScope-id }}' --required
...
```sql
EXEC entraid.identity_governance.entitlement_management_resource_requests_catalog_resource_scopes_resource.refresh 
@accessPackageResourceRequest-id='{{ accessPackageResourceRequest-id }}' --required, 
