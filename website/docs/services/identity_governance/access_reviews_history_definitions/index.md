...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.access_reviews_history_definitions" /></td></tr>
</tbody></table>
...
scopes,
status
FROM entraid.identity_governance.access_reviews_history_definitions
...
```sql
INSERT INTO entraid.identity_governance.access_reviews_history_definitions (
id,
@odata.type,
createdBy,
createdDateTime,
...
```sql
UPDATE entraid.identity_governance.access_reviews_history_definitions
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
createdBy = '{{ createdBy }}',
...
```sql
DELETE FROM entraid.identity_governance.access_reviews_history_definitions
WHERE accessReviewHistoryDefinition-id = '{{ accessReviewHistoryDefinition-id }}' --required
