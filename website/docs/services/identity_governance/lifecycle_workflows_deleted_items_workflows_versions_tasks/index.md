...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.lifecycle_workflows_deleted_items_workflows_versions_tasks" /></td></tr>
</tbody></table>
...
FROM entraid.identity_governance.lifecycle_workflows_deleted_items_workflows_versions_tasks
...
```sql
INSERT INTO entraid.identity_governance.lifecycle_workflows_deleted_items_workflows_versions_tasks (
id,
@odata.type,
arguments,
category,
...
```sql
UPDATE entraid.identity_governance.lifecycle_workflows_deleted_items_workflows_versions_tasks
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
arguments = '{{ arguments }}',
...
```sql
DELETE FROM entraid.identity_governance.lifecycle_workflows_deleted_items_workflows_versions_tasks
WHERE workflow-id = '{{ workflow-id }}' --required
AND workflowVersion-versionNumber = '{{ workflowVersion-versionNumber }}' --required
AND task-id = '{{ task-id }}' --required
