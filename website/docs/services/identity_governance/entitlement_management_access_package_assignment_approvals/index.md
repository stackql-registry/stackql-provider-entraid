--- 
title: entitlement_management_access_package_assignment_approvals
hide_title: false
...
Creates, updates, deletes, gets or lists an <code>entitlement_management_access_package_assignment_approvals</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="entitlement_management_access_package_assignment_approvals" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_governance.entitlement_management_access_package_assignment_approvals" /></td></tr>
</tbody></table>
...
@odata.type,
stages
FROM entraid.identity_governance.entitlement_management_access_package_assignment_approvals
...
```sql
INSERT INTO entraid.identity_governance.entitlement_management_access_package_assignment_approvals (
id,
@odata.type,
stages
)
...
```sql
UPDATE entraid.identity_governance.entitlement_management_access_package_assignment_approvals
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
stages = '{{ stages }}'
...
```sql
DELETE FROM entraid.identity_governance.entitlement_management_access_package_assignment_approvals
WHERE approval-id = '{{ approval-id }}' --required
