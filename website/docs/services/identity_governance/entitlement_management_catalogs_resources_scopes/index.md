--- 
title: entitlement_management_catalogs_resources_scopes
hide_title: false
hide_table_of_contents: false
keywords:
  - entitlement_management_catalogs_resources_scopes
  - identity_governance
  - entra_id
...
Creates, updates, deletes, gets or lists an <code>entitlement_management_catalogs_resources_scopes</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="entitlement_management_catalogs_resources_scopes" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.identity_governance.entitlement_management_catalogs_resources_scopes" /></td></tr>
</tbody></table>
...
originSystem,
resource
FROM entra_id.identity_governance.entitlement_management_catalogs_resources_scopes
...
```sql
INSERT INTO entra_id.identity_governance.entitlement_management_catalogs_resources_scopes (
id,
@odata.type,
description,
displayName,
...
- name: entitlement_management_catalogs_resources_scopes
  props:
    - name: accessPackageCatalog-id
      value: "{{ accessPackageCatalog-id }}"
      description: Required parameter for the entitlement_management_catalogs_resources_scopes resource.
...
```sql
UPDATE entra_id.identity_governance.entitlement_management_catalogs_resources_scopes
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entra_id.identity_governance.entitlement_management_catalogs_resources_scopes
WHERE accessPackageCatalog-id = '{{ accessPackageCatalog-id }}' --required
AND accessPackageResource-id = '{{ accessPackageResource-id }}' --required
AND accessPackageResourceScope-id = '{{ accessPackageResourceScope-id }}' --required
