...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.authentication_methods_policy.authentication_methods_policy" /></td></tr>
</tbody></table>
...
FROM entraid.authentication_methods_policy.authentication_methods_policy
WHERE $select = '{{ $select }}'
AND $expand = '{{ $expand }}'
;
```
...
```sql
UPDATE entraid.authentication_methods_policy.authentication_methods_policy
SET 
id = '{{ id }}',
