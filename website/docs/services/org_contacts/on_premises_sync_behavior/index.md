--- 
title: on_premises_sync_behavior
hide_title: false
...
Creates, updates, deletes, gets or lists an <code>on_premises_sync_behavior</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="on_premises_sync_behavior" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.org_contacts.on_premises_sync_behavior" /></td></tr>
</tbody></table>
...
@odata.type,
isCloudManaged
FROM entraid.org_contacts.on_premises_sync_behavior
...
```sql
UPDATE entraid.org_contacts.on_premises_sync_behavior
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.org_contacts.on_premises_sync_behavior
WHERE orgContact-id = '{{ orgContact-id }}' --required
