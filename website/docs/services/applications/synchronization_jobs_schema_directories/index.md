...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.applications.synchronization_jobs_schema_directories" /></td></tr>
</tbody></table>
...
readOnly,
version
FROM entraid.applications.synchronization_jobs_schema_directories
...
```sql
INSERT INTO entraid.applications.synchronization_jobs_schema_directories (
id,
@odata.type,
discoverabilities,
discoveryDateTime,
...
```sql
UPDATE entraid.applications.synchronization_jobs_schema_directories
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
...
```sql
DELETE FROM entraid.applications.synchronization_jobs_schema_directories
WHERE application-id = '{{ application-id }}' --required
AND synchronizationJob-id = '{{ synchronizationJob-id }}' --required
AND directoryDefinition-id = '{{ directoryDefinition-id }}' --required
