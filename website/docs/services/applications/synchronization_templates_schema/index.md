...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.applications.synchronization_templates_schema" /></td></tr>
</tbody></table>
...
version
FROM entraid.applications.synchronization_templates_schema
...
```sql
UPDATE entraid.applications.synchronization_templates_schema
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.applications.synchronization_templates_schema
WHERE application-id = '{{ application-id }}' --required
AND synchronizationTemplate-id = '{{ synchronizationTemplate-id }}' --required
