--- 
title: synchronization_templates_schema
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>synchronization_templates_schema</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="synchronization_templates_schema" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.applications.synchronization_templates_schema" /></td></tr>
</tbody></table>
...
version
FROM entra_id.applications.synchronization_templates_schema
...
```sql
UPDATE entra_id.applications.synchronization_templates_schema
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entra_id.applications.synchronization_templates_schema
WHERE application-id = '{{ application-id }}' --required
AND synchronizationTemplate-id = '{{ synchronizationTemplate-id }}' --required
