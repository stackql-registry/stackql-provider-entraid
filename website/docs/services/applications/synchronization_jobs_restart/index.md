...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.applications.synchronization_jobs_restart" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO entraid.applications.synchronization_jobs_restart (
criteria,
application-id,
