...
Creates, updates, deletes, gets or lists a <code>domain_dns_records</code> resource.
...
<tr>
    ...
    <td><a href="#parameter-domainDnsRecord-id"><code>domainDnsRecord-id</code></a></td>
...
<tr>
    ...
    <td><a href="#parameter-domainDnsRecord-id"><code>domainDnsRecord-id</code></a>, <a href="#parameter-@odata.type"><code>@odata.type</code></a></td>
    <td></td>
    <td></td>
</tr>
<tr>
...
ttl = {{ ttl }}
WHERE 
domainDnsRecord-id = '{{ domainDnsRecord-id }}' --required
