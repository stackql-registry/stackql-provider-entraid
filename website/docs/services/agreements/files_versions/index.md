...
Creates, updates, deletes, gets or lists a <code>files_versions</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="files_versions" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.agreements.files_versions" /></td></tr>
</tbody></table>
...
isMajorVersion,
language
FROM entraid.agreements.files_versions
...
```sql
INSERT INTO entraid.agreements.files_versions (
id,
@odata.type,
createdDateTime,
displayName,
...
```sql
UPDATE entraid.agreements.files_versions
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
...
```sql
DELETE FROM entraid.agreements.files_versions
WHERE agreement-id = '{{ agreement-id }}' --required
AND agreementFileLocalization-id = '{{ agreementFileLocalization-id }}' --required
AND agreementFileVersion-id = '{{ agreementFileVersion-id }}' --required
