...
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.users.extensions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-user-id"><code>user-id</code></a>, <a href="#parameter-extension-id"><code>extension-id</code></a></td>
...
<tr>
    ...
    <td><a href="#parameter-user-id"><code>user-id</code></a>, <a href="#parameter-extension-id"><code>extension-id</code></a>, <a href="#parameter-@odata.type"><code>@odata.type</code></a></td>
    <td></td>
    <td></td>
</tr>
<tr>
...
id,
@odata.type
FROM entra_id.users.extensions
...
```sql
INSERT INTO entra_id.users.extensions (
id,
@odata.type,
user-id
)
...
```sql
UPDATE entra_id.users.extensions
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entra_id.users.extensions
WHERE user-id = '{{ user-id }}' --required
AND extension-id = '{{ extension-id }}' --required
