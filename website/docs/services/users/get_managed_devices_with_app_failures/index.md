...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.users.get_managed_devices_with_app_failures" /></td></tr>
</tbody></table>
...
SELECT
*
FROM entraid.users.get_managed_devices_with_app_failures
