...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.users.authentication_microsoft_authenticator_methods" /></td></tr>
</tbody></table>
...
displayName,
phoneAppVersion
FROM entraid.users.authentication_microsoft_authenticator_methods
...
```sql
DELETE FROM entraid.users.authentication_microsoft_authenticator_methods
WHERE user-id = '{{ user-id }}' --required
AND microsoftAuthenticatorAuthenticationMethod-id = '{{ microsoftAuthenticatorAuthenticationMethod-id }}' --required
