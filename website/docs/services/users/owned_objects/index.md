...
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.users.owned_objects" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Get the list of directory objects that are owned by the agentUser.</td>
</tr>
</tbody>
</table>
...
@odata.type,
deletedDateTime
FROM entra_id.users.owned_objects
