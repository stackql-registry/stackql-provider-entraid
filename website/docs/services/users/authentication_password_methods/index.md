...
<tr>
    ...
    <td><a href="#parameter-user-id"><code>user-id</code></a>, <a href="#parameter-passwordAuthenticationMethod-id"><code>passwordAuthenticationMethod-id</code></a></td>
...
<tbody>
<tr id="parameter-passwordAuthenticationMethod-id">
    <td><CopyableCode code="passwordAuthenticationMethod-id" /></td>
    <td><code>string</code></td>
