...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.permission_grants.permission_grants" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-resourceSpecificPermissionGrant-id"><code>resourceSpecificPermissionGrant-id</code></a></td>
...
<tr>
    ...
    <td><a href="#parameter-resourceSpecificPermissionGrant-id"><code>resourceSpecificPermissionGrant-id</code></a>, <a href="#parameter-@odata.type"><code>@odata.type</code></a></td>
    <td></td>
    <td></td>
</tr>
<tr>
...
permissionType,
resourceAppId
FROM entraid.permission_grants.permission_grants
WHERE resourceSpecificPermissionGrant-id = '{{ resourceSpecificPermissionGrant-id }}' -- required
AND $select = '{{ $select }}'
AND $expand = '{{ $expand }}'
;
```
...
```sql
INSERT INTO entraid.permission_grants.permission_grants (
id,
@odata.type,
deletedDateTime,
clientAppId,
...
```sql
UPDATE entraid.permission_grants.permission_grants
SET 
id = '{{ id }}',
...
WHERE 
resourceSpecificPermissionGrant-id = '{{ resourceSpecificPermissionGrant-id }}' --required
...
```sql
DELETE FROM entraid.permission_grants.permission_grants
WHERE resourceSpecificPermissionGrant-id = '{{ resourceSpecificPermissionGrant-id }}' --required
...
```sql
EXEC entraid.permission_grants.permission_grants.get_available_extension_properties 
@@json=
'{
...
```sql
EXEC entraid.permission_grants.permission_grants.get_by_ids 
@@json=
'{
"ids": "{{ ids }}", 
"types": "{{ types }}"
...
```sql
EXEC entraid.permission_grants.permission_grants.validate_properties 
@@json=
'{
...
```sql
EXEC entraid.permission_grants.permission_grants.check_member_groups 
@resourceSpecificPermissionGrant-id='{{ resourceSpecificPermissionGrant-id }}' --required 
@@json=
'{
"groupIds": "{{ groupIds }}"
...
```sql
EXEC entraid.permission_grants.permission_grants.check_member_objects 
@resourceSpecificPermissionGrant-id='{{ resourceSpecificPermissionGrant-id }}' --required 
@@json=
'{
"ids": "{{ ids }}"
...
```sql
EXEC entraid.permission_grants.permission_grants.get_member_groups 
@resourceSpecificPermissionGrant-id='{{ resourceSpecificPermissionGrant-id }}' --required 
@@json=
'{
...
```sql
EXEC entraid.permission_grants.permission_grants.get_member_objects 
@resourceSpecificPermissionGrant-id='{{ resourceSpecificPermissionGrant-id }}' --required 
@@json=
'{
"securityEnabledOnly": {{ securityEnabledOnly }}
...
```sql
EXEC entraid.permission_grants.permission_grants.restore 
@resourceSpecificPermissionGrant-id='{{ resourceSpecificPermissionGrant-id }}' --required
;
```
</TabItem>
