...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_protection.risky_service_principals_history" /></td></tr>
</tbody></table>
...
FROM entraid.identity_protection.risky_service_principals_history
...
```sql
INSERT INTO entraid.identity_protection.risky_service_principals_history (
id,
@odata.type,
appId,
displayName,
...
```sql
UPDATE entraid.identity_protection.risky_service_principals_history
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
appId = '{{ appId }}',
...
```sql
DELETE FROM entraid.identity_protection.risky_service_principals_history
WHERE riskyServicePrincipal-id = '{{ riskyServicePrincipal-id }}' --required
AND riskyServicePrincipalHistoryItem-id = '{{ riskyServicePrincipalHistoryItem-id }}' --required
