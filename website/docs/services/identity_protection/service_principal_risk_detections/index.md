...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_protection.service_principal_risk_detections" /></td></tr>
</tbody></table>
...
source,
tokenIssuerType
FROM entraid.identity_protection.service_principal_risk_detections
...
```sql
INSERT INTO entraid.identity_protection.service_principal_risk_detections (
id,
@odata.type,
activity,
activityDateTime,
...
```sql
UPDATE entraid.identity_protection.service_principal_risk_detections
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entraid.identity_protection.service_principal_risk_detections
WHERE servicePrincipalRiskDetection-id = '{{ servicePrincipalRiskDetection-id }}' --required
