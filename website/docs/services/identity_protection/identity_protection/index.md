...
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.identity_protection.identity_protection" /></td></tr>
</tbody></table>
...
FROM entraid.identity_protection.identity_protection
WHERE $select = '{{ $select }}'
AND $expand = '{{ $expand }}'
;
```
...
```sql
UPDATE entraid.identity_protection.identity_protection
SET 
