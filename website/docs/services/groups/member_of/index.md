...
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.groups.member_of" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Get security groups, administrative units, and admin roles that the security group is a direct member of, or administrative units and admin roles that the Microsoft 365 group is a direct member of. This operation is not transitive.</td>
</tr>
</tbody>
</table>
...
@odata.type,
deletedDateTime
FROM entra_id.groups.member_of
