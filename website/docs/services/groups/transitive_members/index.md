...
Creates, updates, deletes, gets or lists a <code>transitive_members</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="transitive_members" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.groups.transitive_members" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Get a list of the group's members. A group can have different object types as members. For more information about supported member types for different groups, see Group membership. This operation is transitive and returns a flat list of all nested members. An attempt to filter by an OData cast that represents an unsupported member type returns a 400 Bad Request error with the Request_UnsupportedQuery code.</td>
</tr>
</tbody>
</table>
...
@odata.type,
deletedDateTime
FROM entraid.groups.transitive_members
