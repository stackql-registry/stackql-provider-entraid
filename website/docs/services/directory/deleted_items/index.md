...
Creates, updates, deletes, gets or lists a <code>deleted_items</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="deleted_items" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entraid.directory.deleted_items" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Permanently delete a recently deleted directory object from deleted items. The following types are supported:<br />- application<br />- agentIdentityBlueprint<br />- agentIdentity<br />- agentIdentityBlueprintPrincipal<br />- agentUser<br />- certificateBasedAuthPki<br />- certificateAuthorityDetail<br />- group<br />- servicePrincipal<br />- user After an item is permanently deleted, it cannot be restored. Administrative units cannot be permanently deleted by using the deletedItems API. Soft-deleted administrative units will be permanently deleted 30 days after initial deletion unless they are restored.</td>
</tr>
<tr>
...
@odata.type,
deletedDateTime
FROM entraid.directory.deleted_items
...
```sql
DELETE FROM entraid.directory.deleted_items
WHERE directoryObject-id = '{{ directoryObject-id }}' --required
...
```sql
EXEC entraid.directory.deleted_items.get_available_extension_properties 
@@json=
'{
...
```sql
EXEC entraid.directory.deleted_items.get_by_ids 
@@json=
'{
"ids": "{{ ids }}", 
"types": "{{ types }}"
...
```sql
EXEC entraid.directory.deleted_items.validate_properties 
@@json=
'{
...
```sql
EXEC entraid.directory.deleted_items.check_member_groups 
...
```sql
EXEC entraid.directory.deleted_items.check_member_objects 
@directoryObject-id='{{ directoryObject-id }}' --required 
@@json=
'{
"ids": "{{ ids }}"
...
```sql
EXEC entraid.directory.deleted_items.get_member_groups 
@directoryObject-id='{{ directoryObject-id }}' --required 
@@json=
'{
...
```sql
EXEC entraid.directory.deleted_items.get_member_objects 
@directoryObject-id='{{ directoryObject-id }}' --required 
@@json=
'{
"securityEnabledOnly": {{ securityEnabledOnly }}
...
```sql
EXEC entraid.directory.deleted_items.restore 
@directoryObject-id='{{ directoryObject-id }}' --required
;
```
</TabItem>
