...
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.organization.extensions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-organization-id"><code>organization-id</code></a>, <a href="#parameter-extension-id"><code>extension-id</code></a></td>
...
<tr>
    ...
    <td><a href="#parameter-organization-id"><code>organization-id</code></a>, <a href="#parameter-extension-id"><code>extension-id</code></a>, <a href="#parameter-@odata.type"><code>@odata.type</code></a></td>
    <td></td>
    <td></td>
</tr>
<tr>
...
<tbody>
<tr id="parameter-extension-id">
    <td><CopyableCode code="extension-id" /></td>
    <td><code>string</code></td>
...
id,
@odata.type
FROM entra_id.organization.extensions
...
```sql
INSERT INTO entra_id.organization.extensions (
id,
@odata.type,
organization-id
)
...
```sql
UPDATE entra_id.organization.extensions
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entra_id.organization.extensions
WHERE organization-id = '{{ organization-id }}' --required
AND extension-id = '{{ extension-id }}' --required
