--- 
title: file_localizations_versions
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>file_localizations_versions</code> resource.
...
- name: file_localizations_versions
  props:
    - name: agreement_id
      value: "{{ agreement_id }}"
      description: Required parameter for the file_localizations_versions resource.
