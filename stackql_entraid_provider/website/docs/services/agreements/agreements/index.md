...
<tr>
    ...
    <td>Default PDF linked to this agreement. (x-ms-discriminator-value: #microsoft.graph.agreementFile, title: entity)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>object</code></td>
    <td>Expiration schedule and frequency of agreement for all users. Supports $filter (eq). (title: termsExpiration)</td>
</tr>
<tr>
