--- 
title: terms_of_use_agreements_files_versions
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>terms_of_use_agreements_files_versions</code> resource.
...
- name: terms_of_use_agreements_files_versions
  props:
    - name: agreement_id
      value: "{{ agreement_id }}"
      description: Required parameter for the terms_of_use_agreements_files_versions resource.
