--- 
title: entitlement_management_resources
hide_title: false
hide_table_of_contents: false
keywords:
  - entitlement_management_resources
  - identity_governance
  - entra_id
...
Creates, updates, deletes, gets or lists an <code>entitlement_management_resources</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="entitlement_management_resources" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.identity_governance.entitlement_management_resources" /></td></tr>
</tbody></table>
...
roles,
scopes
FROM entra_id.identity_governance.entitlement_management_resources
...
```sql
INSERT INTO entra_id.identity_governance.entitlement_management_resources (
id,
@odata.type,
attributes,
createdDateTime,
...
- name: entitlement_management_resources
  props:
    - name: id
      value: "{{ id }}"
      description: |
...
```sql
UPDATE entra_id.identity_governance.entitlement_management_resources
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
...
```sql
DELETE FROM entra_id.identity_governance.entitlement_management_resources
WHERE accessPackageResource-id = '{{ accessPackageResource-id }}' --required
...
```sql
EXEC entra_id.identity_governance.entitlement_management_resources.refresh 
@accessPackageResource-id='{{ accessPackageResource-id }}' --required
;
```
</TabItem>
