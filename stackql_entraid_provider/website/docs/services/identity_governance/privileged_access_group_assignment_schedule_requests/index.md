--- 
title: privileged_access_group_assignment_schedule_requests
hide_title: false
hide_table_of_contents: false
keywords:
  - privileged_access_group_assignment_schedule_requests
  - identity_governance
  - entra_id
...
Creates, updates, deletes, gets or lists a <code>privileged_access_group_assignment_schedule_requests</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="privileged_access_group_assignment_schedule_requests" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.identity_governance.privileged_access_group_assignment_schedule_requests" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Read the properties and relationships of a privilegedAccessGroupAssignmentScheduleRequest object.</td>
</tr>
<tr>
    ...
    <td>Get a list of the privilegedAccessGroupAssignmentScheduleRequest objects and their properties.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Create a new privilegedAccessGroupAssignmentScheduleRequest object.</td>
</tr>
<tr>
    <td><a href="#update"><CopyableCode code="update" /></a></td>
    <td><CopyableCode code="update" /></td>
    <td><a href="#parameter-privilegedAccessGroupAssignmentScheduleRequest-id"><code>privilegedAccessGroupAssignmentScheduleRequest-id</code></a>, <a href="#parameter-@odata.type"><code>@odata.type</code></a></td>
    <td></td>
    <td></td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-privilegedAccessGroupAssignmentScheduleRequest-id"><code>privilegedAccessGroupAssignmentScheduleRequest-id</code></a></td>
    <td></td>
    <td>Cancel an access assignment request to a group whose membership and ownership are governed by PIM.</td>
</tr>
</tbody>
</table>
...
targetScheduleId,
ticketInfo
FROM entra_id.identity_governance.privileged_access_group_assignment_schedule_requests
...
```sql
INSERT INTO entra_id.identity_governance.privileged_access_group_assignment_schedule_requests (
id,
@odata.type,
approvalId,
completedDateTime,
...
- name: privileged_access_group_assignment_schedule_requests
  props:
    - name: id
      value: "{{ id }}"
      description: |
...
```sql
UPDATE entra_id.identity_governance.privileged_access_group_assignment_schedule_requests
SET 
id = '{{ id }}',
...
WHERE 
privilegedAccessGroupAssignmentScheduleRequest-id = '{{ privilegedAccessGroupAssignmentScheduleRequest-id }}' --required
...
```sql
DELETE FROM entra_id.identity_governance.privileged_access_group_assignment_schedule_requests
WHERE privilegedAccessGroupAssignmentScheduleRequest-id = '{{ privilegedAccessGroupAssignmentScheduleRequest-id }}' --required
...
```sql
EXEC entra_id.identity_governance.privileged_access_group_assignment_schedule_requests.cancel 
@privilegedAccessGroupAssignmentScheduleRequest-id='{{ privilegedAccessGroupAssignmentScheduleRequest-id }}' --required
;
```
</TabItem>
