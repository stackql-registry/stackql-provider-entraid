--- 
title: entitlement_management_resource_environments_resources_roles_resource_scopes
hide_title: false
hide_table_of_contents: false
keywords:
  - entitlement_management_resource_environments_resources_roles_resource_scopes
  - identity_governance
  - entra_id
...
Creates, updates, deletes, gets or lists an <code>entitlement_management_resource_environments_resources_roles_resource_scopes</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="entitlement_management_resource_environments_resources_roles_resource_scopes" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.identity_governance.entitlement_management_resource_environments_resources_roles_resource_scopes" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-accessPackageResourceEnvironment-id"><code>accessPackageResourceEnvironment-id</code></a>, <a href="#parameter-accessPackageResource-id"><code>accessPackageResource-id</code></a>, <a href="#parameter-accessPackageResourceRole-id"><code>accessPackageResourceRole-id</code></a></td>
...
originSystem,
resource
FROM entra_id.identity_governance.entitlement_management_resource_environments_resources_roles_resource_scopes
...
```sql
INSERT INTO entra_id.identity_governance.entitlement_management_resource_environments_resources_roles_resource_scopes (
id,
@odata.type,
description,
displayName,
...
- name: entitlement_management_resource_environments_resources_roles_resource_scopes
  props:
    - name: accessPackageResourceEnvironment-id
      value: "{{ accessPackageResourceEnvironment-id }}"
      description: Required parameter for the entitlement_management_resource_environments_resources_roles_resource_scopes resource.
...
```sql
UPDATE entra_id.identity_governance.entitlement_management_resource_environments_resources_roles_resource_scopes
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entra_id.identity_governance.entitlement_management_resource_environments_resources_roles_resource_scopes
WHERE accessPackageResourceEnvironment-id = '{{ accessPackageResourceEnvironment-id }}' --required
AND accessPackageResource-id = '{{ accessPackageResource-id }}' --required
AND accessPackageResourceRole-id = '{{ accessPackageResourceRole-id }}' --required
AND accessPackageResourceScope-id = '{{ accessPackageResourceScope-id }}' --required
