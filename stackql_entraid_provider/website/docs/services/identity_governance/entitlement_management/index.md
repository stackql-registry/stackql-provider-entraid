...
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.identity_governance.entitlement_management" /></td></tr>
</tbody></table>
...
```sql
DELETE FROM entra_id.identity_governance.entitlement_management
