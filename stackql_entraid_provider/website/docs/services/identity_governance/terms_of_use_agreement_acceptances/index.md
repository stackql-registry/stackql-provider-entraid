--- 
title: terms_of_use_agreement_acceptances
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>terms_of_use_agreement_acceptances</code> resource.
...
<tr>
    ...
    <td><a href="#parameter-agreement_acceptance_id"><code>agreement_acceptance_id</code></a></td>
    <td></td>
    <td>Represents the current status of a user's response to a company's customizable terms of use agreement.</td>
</tr>
<tr>
...
- name: terms_of_use_agreement_acceptances
  props:
    - name: id
      value: "{{ id }}"
      description: |
