...
<tr>
    ...
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-access_package_resource_request_id"><code>access_package_resource_request_id</code></a>, <a href="#parameter-access_package_resource_id"><code>access_package_resource_id</code></a>, <a href="#parameter-access_package_resource_scope_id"><code>access_package_resource_scope_id</code></a></td>
    <td></td>
    <td>Read-only. Nullable. Supports $expand.</td>
</tr>
<tr>
...
- name: entitlement_management_resource_requests_catalog_resources_scopes_resource_roles
  props:
    ...
    - name: access_package_resource_id
      value: "{{ access_package_resource_id }}"
      description: Required parameter for the entitlement_management_resource_requests_catalog_resources_scopes_resource_roles resource.
