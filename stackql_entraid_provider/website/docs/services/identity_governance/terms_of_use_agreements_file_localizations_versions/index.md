--- 
title: terms_of_use_agreements_file_localizations_versions
hide_title: false
hide_table_of_contents: false
keywords:
  - terms_of_use_agreements_file_localizations_versions
  - identity_governance
  - entra_id
...
Creates, updates, deletes, gets or lists a <code>terms_of_use_agreements_file_localizations_versions</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="terms_of_use_agreements_file_localizations_versions" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.identity_governance.terms_of_use_agreements_file_localizations_versions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code></code></td>
    <td>Data that represents the terms of use PDF document. Read-only.</td>
</tr>
<tr>
...
isMajorVersion,
language
FROM entra_id.identity_governance.terms_of_use_agreements_file_localizations_versions
...
```sql
INSERT INTO entra_id.identity_governance.terms_of_use_agreements_file_localizations_versions (
id,
@odata.type,
createdDateTime,
displayName,
...
- name: terms_of_use_agreements_file_localizations_versions
  props:
    - name: agreement-id
      value: "{{ agreement-id }}"
      description: Required parameter for the terms_of_use_agreements_file_localizations_versions resource.
...
```sql
UPDATE entra_id.identity_governance.terms_of_use_agreements_file_localizations_versions
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entra_id.identity_governance.terms_of_use_agreements_file_localizations_versions
WHERE agreement-id = '{{ agreement-id }}' --required
AND agreementFileLocalization-id = '{{ agreementFileLocalization-id }}' --required
AND agreementFileVersion-id = '{{ agreementFileVersion-id }}' --required
