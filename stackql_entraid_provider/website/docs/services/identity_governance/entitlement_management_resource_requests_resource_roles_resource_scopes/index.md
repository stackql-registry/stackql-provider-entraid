...
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.identity_governance.entitlement_management_resource_requests_resource_roles_resource_scopes" /></td></tr>
</tbody></table>
...
originSystem,
resource
FROM entra_id.identity_governance.entitlement_management_resource_requests_resource_roles_resource_scopes
...
```sql
INSERT INTO entra_id.identity_governance.entitlement_management_resource_requests_resource_roles_resource_scopes (
id,
description,
displayName,
isRootScope,
...
```sql
UPDATE entra_id.identity_governance.entitlement_management_resource_requests_resource_roles_resource_scopes
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entra_id.identity_governance.entitlement_management_resource_requests_resource_roles_resource_scopes
WHERE access_package_resource_request_id = '{{ access_package_resource_request_id }}' --required
AND access_package_resource_role_id = '{{ access_package_resource_role_id }}' --required
AND access_package_resource_scope_id = '{{ access_package_resource_scope_id }}' --required
