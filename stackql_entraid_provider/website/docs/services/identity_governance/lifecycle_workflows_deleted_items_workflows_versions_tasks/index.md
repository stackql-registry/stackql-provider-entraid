--- 
title: lifecycle_workflows_deleted_items_workflows_versions_tasks
hide_title: false
hide_table_of_contents: false
keywords:
  - lifecycle_workflows_deleted_items_workflows_versions_tasks
  - identity_governance
  - entra_id
...
Creates, updates, deletes, gets or lists a <code>lifecycle_workflows_deleted_items_workflows_versions_tasks</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="lifecycle_workflows_deleted_items_workflows_versions_tasks" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.identity_governance.lifecycle_workflows_deleted_items_workflows_versions_tasks" /></td></tr>
</tbody></table>
...
FROM entra_id.identity_governance.lifecycle_workflows_deleted_items_workflows_versions_tasks
...
```sql
INSERT INTO entra_id.identity_governance.lifecycle_workflows_deleted_items_workflows_versions_tasks (
id,
@odata.type,
arguments,
category,
...
- name: lifecycle_workflows_deleted_items_workflows_versions_tasks
  props:
    - name: workflow-id
      value: "{{ workflow-id }}"
      description: Required parameter for the lifecycle_workflows_deleted_items_workflows_versions_tasks resource.
...
```sql
UPDATE entra_id.identity_governance.lifecycle_workflows_deleted_items_workflows_versions_tasks
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
arguments = '{{ arguments }}',
...
```sql
DELETE FROM entra_id.identity_governance.lifecycle_workflows_deleted_items_workflows_versions_tasks
WHERE workflow-id = '{{ workflow-id }}' --required
AND workflowVersion-versionNumber = '{{ workflowVersion-versionNumber }}' --required
AND task-id = '{{ task-id }}' --required
