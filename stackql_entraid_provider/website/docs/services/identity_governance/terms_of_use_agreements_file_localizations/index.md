--- 
title: terms_of_use_agreements_file_localizations
hide_title: false
hide_table_of_contents: false
keywords:
  - terms_of_use_agreements_file_localizations
  - identity_governance
  - entra_id
...
Creates, updates, deletes, gets or lists a <code>terms_of_use_agreements_file_localizations</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="terms_of_use_agreements_file_localizations" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.identity_governance.terms_of_use_agreements_file_localizations" /></td></tr>
</tbody></table>
...
language,
versions
FROM entra_id.identity_governance.terms_of_use_agreements_file_localizations
...
```sql
INSERT INTO entra_id.identity_governance.terms_of_use_agreements_file_localizations (
id,
@odata.type,
createdDateTime,
displayName,
...
- name: terms_of_use_agreements_file_localizations
  props:
    - name: agreement-id
      value: "{{ agreement-id }}"
      description: Required parameter for the terms_of_use_agreements_file_localizations resource.
    - name: id
      value: "{{ id }}"
      description: |
...
```sql
UPDATE entra_id.identity_governance.terms_of_use_agreements_file_localizations
SET 
id = '{{ id }}',
@odata.type = '{{ @odata.type }}',
createdDateTime = '{{ createdDateTime }}',
...
```sql
DELETE FROM entra_id.identity_governance.terms_of_use_agreements_file_localizations
WHERE agreement-id = '{{ agreement-id }}' --required
AND agreementFileLocalization-id = '{{ agreementFileLocalization-id }}' --required
