--- 
title: synchronization_templates_schema_parse_expression
hide_title: false
hide_table_of_contents: false
keywords:
  - synchronization_templates_schema_parse_expression
  - applications
  - entra_id
...
Creates, updates, deletes, gets or lists a <code>synchronization_templates_schema_parse_expression</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="synchronization_templates_schema_parse_expression" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.applications.synchronization_templates_schema_parse_expression" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO entra_id.applications.synchronization_templates_schema_parse_expression (
expression,
testInputObject,
...
- name: synchronization_templates_schema_parse_expression
  props:
    - name: application-id
      value: "{{ application-id }}"
      description: Required parameter for the synchronization_templates_schema_parse_expression resource.
