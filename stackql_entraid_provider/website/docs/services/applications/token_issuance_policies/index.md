...
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.applications.token_issuance_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>List the tokenIssuancePolicy objects that are assigned to an application.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-application-id"><code>application-id</code></a></td>
    <td></td>
    <td>Assign a tokenIssuancePolicy to an application.</td>
</tr>
<tr>
    <td><a href="#remove_ref"><CopyableCode code="remove_ref" /></a></td>
    <td><CopyableCode code="delete" /></td>
    <td><a href="#parameter-application-id"><code>application-id</code></a>, <a href="#parameter-tokenIssuancePolicy-id"><code>tokenIssuancePolicy-id</code></a></td>
    <td><a href="#parameter-If-Match"><code>If-Match</code></a></td>
    <td>Remove a tokenIssuancePolicy from an application.</td>
</tr>
<tr>
...
FROM entra_id.applications.token_issuance_policies
...
```sql
INSERT INTO entra_id.applications.token_issuance_policies (
@odata.id,
application-id
)
SELECT 
...
- name: token_issuance_policies
  props:
    - name: application-id
      ...
      description: Required parameter for the token_issuance_policies resource.
    - name: @odata.id
      value: "{{ @odata.id }}"
`}</CodeBlock>
...
```sql
DELETE FROM entra_id.applications.token_issuance_policies
WHERE application-id = '{{ application-id }}' --required
AND tokenIssuancePolicy-id = '{{ tokenIssuancePolicy-id }}' --required
