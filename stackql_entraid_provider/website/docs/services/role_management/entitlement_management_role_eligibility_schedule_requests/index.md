--- 
title: entitlement_management_role_eligibility_schedule_requests
hide_title: false
...
Creates, updates, deletes, gets or lists an <code>entitlement_management_role_eligibility_schedule_requests</code> resource.
...
- name: entitlement_management_role_eligibility_schedule_requests
  props:
    - name: id
      value: "{{ id }}"
      description: |
