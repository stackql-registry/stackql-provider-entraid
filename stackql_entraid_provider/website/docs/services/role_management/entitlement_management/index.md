...
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.role_management.entitlement_management" /></td></tr>
</tbody></table>
...
FROM entra_id.role_management.entitlement_management
WHERE $select = '{{ $select }}'
AND $expand = '{{ $expand }}'
;
```
...
```sql
UPDATE entra_id.role_management.entitlement_management
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entra_id.role_management.entitlement_management
