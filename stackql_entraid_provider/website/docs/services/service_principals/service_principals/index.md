...
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.service_principals.service_principals" /></td></tr>
</tbody></table>
...
```sql
EXEC entra_id.service_principals.service_principals.get_available_extension_properties 
@@json=
'{
...
```sql
EXEC entra_id.service_principals.service_principals.get_by_ids 
@@json=
'{
"ids": "{{ ids }}", 
"types": "{{ types }}"
...
```sql
EXEC entra_id.service_principals.service_principals.validate_properties 
@@json=
'{
