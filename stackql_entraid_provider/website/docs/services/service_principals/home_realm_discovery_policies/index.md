...
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.service_principals.home_realm_discovery_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>List the homeRealmDiscoveryPolicy objects that are assigned to a servicePrincipal.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-service_principal_id"><code>service_principal_id</code></a></td>
    <td></td>
    <td>Assign a homeRealmDiscoveryPolicy to a servicePrincipal.</td>
</tr>
<tr>
    <td><a href="#remove_ref"><CopyableCode code="remove_ref" /></a></td>
    <td><CopyableCode code="delete" /></td>
    <td><a href="#parameter-service_principal_id"><code>service_principal_id</code></a>, <a href="#parameter-home_realm_discovery_policy_id"><code>home_realm_discovery_policy_id</code></a></td>
    <td><a href="#parameter-If-Match"><code>If-Match</code></a></td>
    <td>Remove a homeRealmDiscoveryPolicy from a servicePrincipal.</td>
</tr>
<tr>
...
<tbody>
<tr id="parameter-home_realm_discovery_policy_id">
    <td><CopyableCode code="home_realm_discovery_policy_id" /></td>
    <td><code>string</code></td>
...
FROM entra_id.service_principals.home_realm_discovery_policies
...
```sql
INSERT INTO entra_id.service_principals.home_realm_discovery_policies (
directoryObjectId,
...
- name: home_realm_discovery_policies
  props:
    - name: service_principal_id
      ...
      description: Required parameter for the home_realm_discovery_policies resource.
...
```sql
DELETE FROM entra_id.service_principals.home_realm_discovery_policies
WHERE service_principal_id = '{{ service_principal_id }}' --required
AND home_realm_discovery_policy_id = '{{ home_realm_discovery_policy_id }}' --required
