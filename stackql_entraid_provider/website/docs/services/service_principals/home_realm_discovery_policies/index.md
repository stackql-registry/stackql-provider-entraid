...
<tr>
    ...
    <td><a href="#parameter-servicePrincipal-id"><code>servicePrincipal-id</code></a>, <a href="#parameter-homeRealmDiscoveryPolicy-id"><code>homeRealmDiscoveryPolicy-id</code></a></td>
...
WHERE servicePrincipal-id = '{{ servicePrincipal-id }}' --required
AND homeRealmDiscoveryPolicy-id = '{{ homeRealmDiscoveryPolicy-id }}' --required
