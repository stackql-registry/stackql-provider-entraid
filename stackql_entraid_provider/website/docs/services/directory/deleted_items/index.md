...
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.directory.deleted_items" /></td></tr>
</tbody></table>
...
```sql
EXEC entra_id.directory.deleted_items.get_by_ids 
@@json=
'{
"ids": "{{ ids }}", 
"types": "{{ types }}"
...
```sql
EXEC entra_id.directory.deleted_items.validate_properties 
@@json=
'{
...
```sql
EXEC entra_id.directory.deleted_items.check_member_groups 
...
```sql
EXEC entra_id.directory.deleted_items.check_member_objects 
@directory_object_id='{{ directory_object_id }}' --required 
@@json=
'{
"ids": "{{ ids }}"
...
```sql
EXEC entra_id.directory.deleted_items.get_member_groups 
@directory_object_id='{{ directory_object_id }}' --required 
@@json=
'{
...
```sql
EXEC entra_id.directory.deleted_items.get_member_objects 
@directory_object_id='{{ directory_object_id }}' --required 
@@json=
'{
"securityEnabledOnly": {{ securityEnabledOnly }}
...
```sql
EXEC entra_id.directory.deleted_items.restore 
@directory_object_id='{{ directory_object_id }}' --required
;
```
</TabItem>
