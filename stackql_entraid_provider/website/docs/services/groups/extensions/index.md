...
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.groups.extensions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-group-id"><code>group-id</code></a>, <a href="#parameter-extension-id"><code>extension-id</code></a></td>
...
<tr>
    ...
    <td><a href="#parameter-group-id"><code>group-id</code></a>, <a href="#parameter-extension-id"><code>extension-id</code></a>, <a href="#parameter-@odata.type"><code>@odata.type</code></a></td>
    <td></td>
    <td></td>
</tr>
<tr>
...
id,
@odata.type
FROM entra_id.groups.extensions
...
```sql
INSERT INTO entra_id.groups.extensions (
id,
@odata.type,
group-id
)
...
```sql
UPDATE entra_id.groups.extensions
SET 
id = '{{ id }}',
...
```sql
DELETE FROM entra_id.groups.extensions
WHERE group-id = '{{ group-id }}' --required
AND extension-id = '{{ extension-id }}' --required
