...
Creates, updates, deletes, gets or lists a <code>subscribe_by_mail</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="subscribe_by_mail" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="entra_id.groups.subscribe_by_mail" /></td></tr>
</tbody></table>
...
```sql
INSERT INTO entra_id.groups.subscribe_by_mail (
group-id
)
SELECT 
'{{ group-id }}'
...
- name: subscribe_by_mail
  props:
    - name: group-id
      value: "{{ group-id }}"
      description: Required parameter for the subscribe_by_mail resource.
`}</CodeBlock>
