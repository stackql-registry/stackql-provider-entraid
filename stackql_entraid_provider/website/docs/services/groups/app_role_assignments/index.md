...
<tr>
    ...
    <td><a href="#parameter-group-id"><code>group-id</code></a>, <a href="#parameter-appRoleAssignment-id"><code>appRoleAssignment-id</code></a></td>
...
<tr>
    ...
    <td>Retrieve the list of appRoleAssignment that have been granted to a group.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Use this API to assign an app role to a security group. All direct members of the group will be considered assigned. Security groups with dynamic memberships are supported. To grant an app role assignment to a group, you need three identifiers: Additional licenses might be required to use a group to manage access to applications.</td>
</tr>
<tr>
    <td><a href="#update"><CopyableCode code="update" /></a></td>
    <td><CopyableCode code="update" /></td>
    <td><a href="#parameter-group-id"><code>group-id</code></a>, <a href="#parameter-appRoleAssignment-id"><code>appRoleAssignment-id</code></a>, <a href="#parameter-@odata.type"><code>@odata.type</code></a></td>
    <td></td>
    <td></td>
</tr>
<tr>
    ...
    <td>Deletes an appRoleAssignment that a group has been granted.</td>
</tr>
</tbody>
</table>
