...
<tr>
    ...
    <td><a href="#parameter-domain_dns_record_id"><code>domain_dns_record_id</code></a></td>
    <td></td>
    <td></td>
</tr>
<tr>
...
WHERE domain_dns_record_id = '{{ domain_dns_record_id }}' -- required
;
```
</TabItem>
<TabItem value="list">
...
ttl = {{ ttl }}
WHERE 
domain_dns_record_id = '{{ domain_dns_record_id }}' --required
RETURNING
id,
isOptional,
label,
