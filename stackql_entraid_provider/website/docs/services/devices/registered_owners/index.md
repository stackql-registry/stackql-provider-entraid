...
Creates, updates, deletes, gets or lists a <code>registered_owners</code> resource.
...
<tr>
    ...
    <td>Retrieve a list of users that are registered owners of the device. A registered owner is the user that cloud joined the device or registered their personal device. The registered owner is set at the time of registration. Currently, there can be only one owner.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-device-id"><code>device-id</code></a></td>
    <td></td>
    <td>Add a user as a registered owner of the device.</td>
</tr>
<tr>
    <td><a href="#remove_ref"><CopyableCode code="remove_ref" /></a></td>
    <td><CopyableCode code="delete" /></td>
    <td><a href="#parameter-device-id"><code>device-id</code></a>, <a href="#parameter-directoryObject-id"><code>directoryObject-id</code></a></td>
    <td><a href="#parameter-If-Match"><code>If-Match</code></a></td>
    <td>Remove a user as a registered owner of the device.</td>
</tr>
<tr>
    <td><a href="#remove_ref_2"><CopyableCode code="remove_ref_2" /></a></td>
    <td><CopyableCode code="delete" /></td>
    <td><a href="#parameter-@id"><code>@id</code></a>, <a href="#parameter-device-id"><code>device-id</code></a></td>
    <td><a href="#parameter-If-Match"><code>If-Match</code></a></td>
    <td>Remove a user as a registered owner of the device.</td>
</tr>
</tbody>
...
- name: registered_owners
  props:
    - name: device-id
      value: "{{ device-id }}"
      description: Required parameter for the registered_owners resource.
    - name: @odata.id
      value: "{{ @odata.id }}"
`}</CodeBlock>
